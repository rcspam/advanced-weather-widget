...
QtObject {
    ...
    // True once the current provider has written native AQI data for this
    // refresh generation — lets _fetchAqiIfNeeded() skip the Open-Meteo
    // fallback when native data already arrived.
