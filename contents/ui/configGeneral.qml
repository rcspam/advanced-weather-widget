...
KCM.SimpleKCM {
    ...
    readonly property var providerModel: [
        { text: i18n("Open-Meteo (recommended, free)"),   value: "openMeteo"   },
        { text: i18n("met.no (free)"),                    value: "metno"       },
        { text: i18n("OpenWeatherMap (Key Required)"),    value: "openWeather" },
        { text: i18n("WeatherAPI.com (Key Required)"),    value: "weatherApi"  }
    ]

    function providerIndexFor(val) {
        for (var i = 0; i < providerModel.length; ++i)
            if (providerModel[i].value === val) return i
        return 0
    }
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    Kirigami.Heading { text: i18n("Weather Provider"); level: 4 }
                    Rectangle {
                ...
                ColumnLayout {
                    ...
                    Label { text: i18n("Provider:"); opacity: 0.75 }
                    ...
                    Label {
                        ...
                        text: {
                            if (root.isOpenWeather) return i18n("Standard provider. API key required below.")
                            if (root.isWeatherApi)  return i18n("Alternative provider. API key required below.")
                            if (root.cfg_weatherProvider === "metno") return i18n("Free Norwegian Meteorological Institute service. No API key needed.")
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        TextField {
                            id: apiKeyField
                            Layout.fillWidth: true
                            placeholderText: root.isOpenWeather
                                ? i18n("Enter your OpenWeatherMap API key")
                                : i18n("Enter your WeatherAPI.com key")
                        ...
                        ToolButton {
                            ...
                            checkable: true
                            onCheckedChanged: apiKeyField.echoMode = checked
            ...
            ColumnLayout {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    Kirigami.Heading { text: i18n("Data Refresh"); level: 4 }
                    Rectangle {
                        Layout.fillWidth: true; height: 1
                        color: Kirigami.Theme.separatorColor; opacity: 0.5
                    }
